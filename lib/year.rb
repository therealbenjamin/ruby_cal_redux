...
class Year
  ...
  def print_year # NOT final. Need to refactor to do this programatically. 
  	...
  	print "#{jan[7]}" unless jan[7].nil?  
  	print "#{feb[7]}" unless feb[7].nil?
  	print "#{mar[7]}" unless mar[7].nil?
  	...
  	print "#{apr[7]}" unless apr[7].nil?  
  	print "#{may[7]}" unless may[7].nil?
  	print "#{jun[7]}" unless jun[7].nil?
  	...
  	print "#{jul[7]}" unless jul[7].nil?  
  	print "#{aug[7]}" unless aug[7].nil?
  	print "#{sep[7]}" unless sep[7].nil?
